  ...
  return (
    <>
      <InventoryModal
        ...
        inventoryName={inventoryList.find((inventory) => inventory.id === selectedInventoryId)?.item_name}
          ...
          <div className='item-list__container' key={inventory.id}>
            ...
            <div className='item-list__warehouse-container'>
              ...
              <p className='item-list__item item-list__warehouse'>
                {
                  warehouseList.find((warehouse) => warehouse.id === inventory.warehouse_id)
                    ?.warehouse_name
                }
              </p>
            </div>
            ...
            <div className='item-list__buttons-container'>
              ...
              <Link className='item-list__link' to={`/inventory/edit/${inventory.id}`}>
                <img src={EditButton} className='item-list__button' alt='edit-button' />
              </Link>
            </div>
          </div>
        ))}
